...
- [ ] **Phase 1: Tour Platform — Stabilize and Polish** - Fix live security bugs, wire lead capture, complete tour creation flow, and polish the 360° viewer for production
...
|-------|----------------|--------|-----------|
| 1. Tour Platform — Stabilize and Polish | 3/5 | In Progress|  |
