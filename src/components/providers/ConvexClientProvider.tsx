  ...
  return (
    <ClerkProvider
      ...
      appearance={{
        ...
        elements: {
          rootBox: '!bg-[#0A0908]',
          userProfile: '!bg-[#12100E]',
          userProfile__root: '!bg-[#12100E]',
          formButtonPrimary: 'bg-[#D4A017] hover:bg-[#E5B120] text-[#0A0908]',
          card: '!bg-[#12100E] border border-[rgba(212,160,23,0.12)]',
          cardBox: '!bg-[#12100E]',
          navbar: '!bg-[#0A0908] border-r border-[rgba(212,160,23,0.08)]',
          navbarButton: '!text-[#A8A29E] hover:!text-[#F5F3EF] hover:!bg-[#1B1916]',
          navbarButtonIcon: '!text-[#A8A29E]',
          pageScrollBox: '!bg-[#12100E]',
          page: '!bg-[#12100E]',
          headerTitle: '!text-[#F5F3EF]',
          headerSubtitle: '!text-[#A8A29E]',
          profileSectionTitleText: '!text-[#F5F3EF]',
          profileSectionContent: '!text-[#A8A29E]',
